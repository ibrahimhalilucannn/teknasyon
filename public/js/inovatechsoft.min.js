...
function(a) {
    ...
    ,
    a(function() {
        a.support.animation = b(),
        a.support.animation && (a.event.special.bsAnimationEnd = {
...
function(a) {
    ...
    function b(b) {
        return this.each(function() {
            var d = a(this)
              , e = d.data("bs.input");
            e || d.data("bs.input", e = new c(this)),
            "string" == typeof b && e[b]()
        })
    }
    var c = function(b) {
    ...
    c.VERSION = "1.0.0",
    c.prototype.checkValue = function() {
    ...
    c.prototype.init = function() {
        ...
        this.$element.on("change.bs.input", a.proxy(this.updateCssClasses, this)).on("focus.bs.input", a.proxy(this._handleInputFocus, this)).on("blur.bs.input", a.proxy(this._handleInputBlur, this)),
        this.updateCssClasses()
    }
    ;
    var d = a.fn.input;
    a.fn.input = b,
    a.fn.input.Constructor = c,
    a.fn.input.noConflict = function() {
        return a.fn.input = d,
        this
    }
    ,
...
function(a) {
    ...
    function b(b, c) {
        ...
        if (f)
            return f;
        var h = {};
        h.type = c.type || c.chart,
        h.type = a.camelCase(h.type),
        d(h, "data.labels", c.labels),
        d(h, "data.datasets", a.map(c.values, function(b) {
            if (b.colorStop1 && b.colorStop2) {
                var d = b.y0
                  , e = b.y1
                  , f = g.createLinearGradient(0, d, 0, e);
                f.addColorStop(0, b.colorStop1),
                f.addColorStop(1, b.colorStop2),
                b.backgroundColor = f,
                b.hoverBackgroundColor = f,
                delete b.colorStop1,
                delete b.colorStop2,
                delete b.y0,
                delete b.y1
            }
            return ~a.inArray("points", c.hide) && (b.pointBackgroundColor = "transparent",
            b.pointBorderColor = "transparent"),
            b
        })),
        d(h, "options", c),
        d(h, "paths", {
...
function(a) {
    ...
    function b(b, d) {
        ...
        if (f)
            return f;
        d = a.extend({}, c, d),
        a.isNumeric(d.start) && (d.start = [d.start]),
        a.isEmptyObject(d.range) && (d.range = {
            max: d.max,
            min: d.min
        }),
        e.addClass([d.cssPrefix.replace(/-$/, ""), d.cssPrefix.concat(d.slider)].join(" ")),
        f = noUiSlider.create(b, d),
        e.data("bs.slider", f)
    }
    var c = {
        connect: "lower",
...
function(a) {
    a.validator.setDefaults({
        ...
        errorPlacement: function(a, b) {
            ...
            c.hasClass("form-horizontal") && (d = b.parent()),
            a.addClass("help-block").appendTo(d)
        },
